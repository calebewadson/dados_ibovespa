...
from src.config import S3_BUCKET_NAME, LOCAL_FILE_PREFIX, LOCAL_FILE_NAME_FORMAT
...
def run_daily_process():
    ...
    file_name = LOCAL_FILE_NAME_FORMAT.format(prefix=LOCAL_FILE_PREFIX)
    s3_object_key = f"raw/{partition_path}/{file_name}"
